...
public class KeyUtil {
     ...
     */
    private static final int KEY_SIZE = 560;
    //公钥一般发放给客户端
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("公钥：/n " + privateKey);
        System.out.println();
        System.out.println("私钥：/n " + publicKey);
        System.out.println();
        Base64.Encoder encoder = Base64.getEncoder();
        System.out.println("公钥：/n " + new String(encoder.encode(publicKey), "UTF-8"));
        System.out.println();
        System.out.println("私钥：/n " + new String(encoder.encode(privateKey), "UTF-8"));
        System.out.println();
        ...
        System.out.println("加密后的数据：" + new String(encoder.encode(code1), "UTF-8"));
        ...
        System.out.println("加密后的数据：" + new String(encoder.encode(code2), "UTF-8"));
